...
class LandAdapter(
    private var listenerHubungi: ItemClickListener<LandData>,
    private var listenerSewa: ItemClickListener<LandData>,
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder {
        val view = LayoutInflater.from(parent.context)
            .inflate(R.layout.item_urban_farming, parent, false)
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        ...
        holder.materialButtonSewaSekarang.setOnClickListener {
            listenerSewa.onClickItem(data)
        }

        holder.imageViewHubungiSekarang.setOnClickListener {
            listenerHubungi.onClickItem(data)
        }
    ...
    class ViewHolder(ItemView: View) : RecyclerView.ViewHolder(ItemView) {
        ...
        val imageViewHubungiSekarang = ItemView.findViewById<View>(R.id.imageViewHubungiSekarang) as ImageView
