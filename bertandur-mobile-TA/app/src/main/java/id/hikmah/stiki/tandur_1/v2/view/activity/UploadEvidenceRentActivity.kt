...
class UploadEvidenceRentActivity : AppCompatActivity() {
    private lateinit var binding: ActivityUploadEvidenceRentBinding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding = ActivityUploadEvidenceRentBinding.inflate(layoutInflater)
            ...
            Activity.RESULT_OK -> {
                ...
                uri.toFile().let {
                    lifecycleScope.launch {
                        Compressor.compress(this@UploadEvidenceRentActivity, it) {
